...
import image from "../../assets/PhotoShoot/11.png";
...
export default function CardContent() {
  return (
    <div className="">
      ...
      <div className="flex justify-center  flex-col lg:flex-row py-5 m-5 lg:w-[130ch] items-center ">
        <div className="text-center it lg:text-left lg:w-1/2 p-4 order-2 lg:order-none">
          <h1 className="text-6xl font-playball text-center  text-yellow-600   font-bold mb-8">
            Safiya's Website
          </h1>
          <h2 className="text-4xl text-center   font-bold mb-8">
