    ...
    <div className="bg-red-100  py-10">
      <div className="flex flex-col lg:flex-row text-center lg:text-left items-center lg:items-start w-full px-4 lg:px-20 space-y-6 lg:space-y-0 lg:space-x-6">
        <div className="w-full lg:w-1/2 text-2xl lg:text-4xl">
          <h1 className="w-full font-playball  lg:w-[10ch] ">
            This is Safi's website. I have been a professional makeup artist . .
            .
          </h1>
        </div>
        <div className="w-full  text-lg lg:text-xl">
          <h1 className="text-6xl text-red-400 pb-5 font-playball ">
            The Best Makeup Artist in Pondicherry.
          </h1>
          <p>
            ...
            <br />
            <br /> Led by the talented and dedicated Safiya, our team is
            composed of skilled professionals who are as passionate about your
            beauty as you are about your special day. With years of experience
            and a deep understanding of the latest trends, Safiya and her team
            have perfected the art of delivering flawless, long-lasting makeup
            that photographs beautifully and leaves a lasting impression.
          </p>
        </div>
      </div>
